			...
			<div className='max-w-7xl mx-auto px-3 sm:px-4 lg:px-8'>
				...
				<div className='mb-6 sm:mb-8'>
								...
								>
									<Card className='border-0 shadow-md hover:shadow-lg transition-all duration-300 hover:-translate-y-1 h-full'>
										<CardContent className='p-3 sm:p-4 md:p-6 h-full flex flex-col'>
											...
											{/* Testimonial Text */}
											<p className='text-gray-700 text-center mb-3 sm:mb-4 leading-relaxed italic text-xs sm:text-sm flex-grow'>
											...
											<div className='text-center mt-auto'>
												<div className='flex items-center justify-center mb-2 sm:mb-3'>
													<div className='w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-full flex items-center justify-center text-white font-bold text-xs'>
														{testimonial.image}
													</div>
												</div>
					...
					<div className='flex justify-center space-x-3 sm:space-x-4 mt-4 sm:mt-6'>
						<button
							onClick={prevSlide}
							className={`flex items-center space-x-1 sm:space-x-2 px-3 sm:px-4 py-2 rounded-lg transition-all duration-200 hover:scale-105 ${
								currentIndex === 0
						...
						>
							...
							<span className='text-xs sm:text-sm font-medium'>Oldingi</span>
						</button>
						<button
							onClick={nextSlide}
							className={`flex items-center space-x-1 sm:space-x-2 px-3 sm:px-4 py-2 rounded-lg transition-all duration-200 hover:scale-105 ${
						...
						>
							<span className='text-xs sm:text-sm font-medium'>Keyingi</span>
				...
				{/* Stats Section */}
				<div className='bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-4 sm:p-6 md:p-8'>
